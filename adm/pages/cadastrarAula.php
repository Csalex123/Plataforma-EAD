...
<body name="curso">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                <form id="formulario-aulas-cadastrar">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">Título da aula</label>
                                                <input type="text" id="txtTitulo" class="form-control" name="titulo" placeholder="Nome">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="data" class="form-control" name="data" placeholder="00/00/0000">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="txtHora" class="form-control" name="hora" placeholder="Exemplo: 20h">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="txtDescricao"  class="html-editor form-control" name="descricao" rows="6"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea id="txtLink" class="html-editor form-control" name="link" rows="4"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="hidden" name="metodo" value="cadastrar-aula">
                                            <input type="hidden" name="idCurso" value="<?php echo $idCurso;?>">
                                            <input type="hidden" name="entidade" value="aula">

                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary" style="float: right;">Cadastrar Aulas</button>
                                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            $("#formulario-aulas-cadastrar").submit(function() {
                ...
                if($("#txtTitulo").val()== null || $("#txtTitulo").val() ==""){
                    ...
                    var formData = new FormData(document.getElementById("formulario-aulas-cadastrar"));
